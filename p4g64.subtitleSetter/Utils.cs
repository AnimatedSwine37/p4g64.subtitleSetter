...
internal class Utils
{
    ...
    internal static void LogDebug(string message)
    {
        if (_config.DebugEnabled)
            _logger.WriteLine($"[Subtitle Setter] {message}");
    }
    ...
    {
        _logger.WriteLine($"[Subtitle Setter] {message}: {e.Message}", System.Drawing.Color.Red);
    }

    internal static void LogError(string message)
    {
        _logger.WriteLine($"[Subtitle Setter] {message}", System.Drawing.Color.Red);
    }
    
    internal static void LogWarn(string message)
    {
        _logger.WriteLine($"[Subtitle Setter] {message}", System.Drawing.Color.Orange);
    }
